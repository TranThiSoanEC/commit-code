...
namespace QuanLyPhongMachTu
{
    public partial class LapPhieuKhamBenh_GUI : Form
    {
        ...
        {
            List<BACSI> dsBs = BACSI_BUS.LoadBacSiThamGiaKhamBenh();
        ...
        public void DuaDuLieuTudgv_Combobox(int Ma)
        {
            ...
            List<BACSI> dsBs = BACSI_BUS.LoadBacSiCanTim(Ma);
            comboBox_MaBS.DataSource = dsBs;
            comboBox_MaBS.DisplayMember = "TenBS1";
            comboBox_MaBS.ValueMember = "MaBS1";
        ...
        private void dgv_PhieuKham_Click_1(object sender, EventArgs e)
        {
           ...
           // DuaDuLieuTudgv_Combobox(int.Parse( dr.Cells["MaBS1"].Value.ToString()));
            ...
            //comboBox_MaBS.Text = dr.Cells["MaBacSi1"].Value.ToString();
        }
        ...
        {
            //KeToaThuoc x = new KeToaThuoc(int.Parse(txb_MaPK.Text.ToString()));
            //x.ShowDialog();
            //this.Hide();
        }
    }
