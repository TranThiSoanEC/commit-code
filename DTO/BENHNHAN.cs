...
namespace DTO
{
    public class BENHNHAN
    {
        ...
        public BENHNHAN(int mabn,string tenbn, DateTime ngaysinh,string diachi,string dienthoai,string gioitinh, int tinhtrangtontai)
        {
            this.MaBN = mabn;
            this.TenBN = tenbn;
            ...
            this.TinhTrangTonTai = tinhtrangtontai;
