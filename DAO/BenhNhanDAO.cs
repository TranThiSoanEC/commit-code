...
namespace DAO
{
    public  class BenhNhanDAO
    {
        ...
        public static List<BENHNHAN> LoadBenhNhan()
        {
            ...
            string sTruyVan = "select * from BENHNHAN where TinhTrangTonTai = '1'";
            // Mo ket noi
        ...
        {
            string sTruyVan = string.Format("SELECT MaBN from BENHNHAN WHERE TinhTrangTonTai = '1' and (TenBN like N'{0}') and (NgaySinh = N'{1}' and (DienThoai = '{2}' and GioiTinh = N'{3}'))", bnDTO.TenBN1, bnDTO.NgaySinh1, bnDTO.DienThoai1, bnDTO.GioiTinh1); // MaBN tu dong tang
            Con = DataProvider_1.KetNoi();
            try
            {
                // thuc thi truy van
        ...
        public static bool XoaBenhNhan(BENHNHAN bnDTO)
        {
            ...
            String sTruyVan = string.Format("update BENHNHAN set TinhTrangTontai = '0' where MaBN ='{0}'", bnDTO.MaBN1);
